          ...
          <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-slate-700/50 p-8 lg:p-10 relative overflow-hidden">
            ...
            <div className="mb-8 relative z-10">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Join us today and start your premium shopping journey
              </p>
            </div>
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <select
                      className="w-full pl-12 pr-10 py-3.5 rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-700/50 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 appearance-none cursor-pointer"
                      value={role}
              ...
              {success && (
                <div className="flex items-center gap-2 p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-400 text-sm animate-in fade-in slide-in-from-top-2">
                  <svg className="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="relative z-10 text-white">
                <div className="mb-6 lg:mb-8">
                  ...
                  <p className="text-base lg:text-lg text-white/90 leading-relaxed">
                    Create an account today to unlock personalized recommendations, track orders, and get early access to sales.
                  </p>
                </div>
                <div className="flex items-center gap-4 pt-6 lg:pt-8 border-t border-white/20">
                  ...
                  <div>
                    <p className="text-sm font-semibold">Start Shopping Now</p>
                    <p className="text-xs text-white/70">Simple, secure, and fast</p>
                  </div>
                </div>
              </div>
            </div>
